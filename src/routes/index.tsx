    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/70 p-4 backdrop-blur-sm">
      <div className="relative w-full max-w-md overflow-hidden rounded-3xl bg-lime-50 p-8 text-slate-900 ring-2 ring-brand-neon shadow-[0_20px_60px_-15px_rgba(16,185,129,0.45)]">
        ...
        <div className="mt-6 text-center">
          ...
          <p className="mt-1 text-sm text-slate-500 line-through">De R$ 27,90</p>
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="relative mt-10 overflow-hidden rounded-2xl">
            ...
            <span className="absolute left-4 top-4 inline-flex items-center gap-1.5 rounded-full bg-white px-3 py-1.5 text-xs font-bold text-slate-900 shadow-lg">
              <span className="flex h-4 w-4 items-center justify-center rounded-full bg-red-100">
                <X className="h-3 w-3 text-red-500" />
              </span>
              Sem os Projetos
            </span>
            <span className="absolute right-4 top-4 inline-flex items-center gap-1.5 rounded-full bg-white px-3 py-1.5 text-xs font-bold text-slate-900 shadow-lg">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 grid items-start gap-5 md:grid-cols-2">
            ...
            <div className="card-border-light rounded-3xl bg-white p-4 shadow-sm">
              ...
              <img src={planoBasicoMockup} alt="Plano Básico" className="hero-mockup-float mx-auto my-2 h-52 md:h-60 w-auto object-contain" />
              ...
              <button
                ...
                className="soft-pulse mt-3 flex w-full items-center justify-center gap-2 rounded-full border border-slate-300 bg-white py-3 font-display text-sm uppercase text-slate-600 transition hover:bg-slate-50"
              >
            ...
            <div id="comprar" className="relative scroll-mt-24 rounded-3xl bg-lime-50 p-4 ring-2 ring-brand-neon shadow-xl">
              ...
              <img src={heroMockup} alt="Plano Completo" className="hero-mockup-float mx-auto my-2 h-52 md:h-60 w-auto object-contain" />
          ...
          <div className="mt-10 overflow-hidden rounded-3xl bg-brand-card ring-1 ring-white/10 shadow-2xl">
            <div className="p-6 sm:p-8">
              ...
              <a
                ...
                className="soft-pulse mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-amber-500 via-orange-500 to-brand-neon py-3.5 font-display text-xs uppercase tracking-wide text-black transition hover:scale-[1.02]"
              >
