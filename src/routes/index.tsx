            ...
            <div className="grid items-center gap-5 md:grid-cols-2">
              <div className="relative">
                ...
                <img
                  ...
                  height={900}
                  loading="lazy"
                  className="hero-mockup-float mx-auto w-full max-w-[85%]"
                />
              </div>
              <div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 grid items-start gap-5 md:grid-cols-2">
            ...
            <div className="card-border-light rounded-3xl bg-white p-4 shadow-sm">
              ...
              <img src={planoBasicoMockup} alt="Plano Básico" className="hero-mockup-float mx-auto my-1 h-44 md:h-52 w-auto object-contain" />
          ...
          <div className="mt-10 overflow-hidden rounded-3xl bg-brand-card ring-1 ring-white/10 shadow-2xl">
            <div className="p-6 sm:p-8">
              ...
              <div className="mt-6 grid grid-cols-3 gap-4 border-y border-white/10 py-4">
                ...
                <div className="text-center">
                  <p className="font-display text-lg text-amber-400">28 mil</p>
